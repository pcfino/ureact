        ...
        Navigator.pushReplacement(
          ...
          MaterialPageRoute(
            builder: (context) => StaticTestPage(
              ...
              slFoamDataAcc: widget.slSolidDataAcc,
              slFoamDataRot: widget.slSolidDataRot,
              slFoamDataFs: widget.slSolidDataFs,
              tlFoamDataRot: widget.tlSolidDataRot,
              tlFoamDataAcc: widget.tlSolidDataAcc,
              tlFoamDataFs: widget.tlSolidDataFs,
              tandFoamDataAcc: widget.tandSolidDataAcc,
              tandFoamDataRot: widget.tandSolidDataRot,
              tandFoamDataFs: widget.tandSolidDataFs,
            ),
          ),
        );
      } else if (widget.stance == "Single Leg Stance (Solid)") {
